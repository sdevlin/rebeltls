...
byte *bytes_vpack(byte *buf, const char *fmt, va_list argp)
{
  struct cmd cmd;
...
byte *bytes_pack(byte *buf, const char *fmt, ...)
{
  va_list argp;
  va_start(argp, fmt);
  buf = bytes_vpack(buf, fmt, argp);
  va_end(argp);
  return buf;
}
...
const byte *bytes_vunpack(const byte *buf, const char *fmt, va_list argp)
{
...
const byte *bytes_unpack(const byte *buf, const char *fmt, ...)
{
  va_list argp;
  va_start(argp, fmt);
  buf = bytes_vunpack(buf, fmt, argp);
  va_end(argp);
  return buf;
}
