...
#define DEC_ROUND(e, a) do {                            \
    e[0] = dec_roundstep(a[0], a[1], a[2], a[3], *w++); \
    e[1] = dec_roundstep(a[1], a[2], a[3], a[0], *w++); \
    e[2] = dec_roundstep(a[2], a[3], a[0], a[1], *w++); \
    e[3] = dec_roundstep(a[3], a[0], a[1], a[2], *w++); \
  } while (0)
...
void aes128_decrypt(const aes128_ctx *ctx, const byte *c, byte *p)
{
  ...
  /* 10 */
  m[0] = dec_finalroundstep(n[0], n[1], n[2], n[3], *w++);
  m[1] = dec_finalroundstep(n[1], n[2], n[3], n[0], *w++);
  m[2] = dec_finalroundstep(n[2], n[3], n[0], n[1], *w++);
  m[3] = dec_finalroundstep(n[3], n[0], n[1], n[2], *w++);
